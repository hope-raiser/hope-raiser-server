...
async function main() {
  ...
  const category5 = await prisma.categories.create({
    data: {
      name: "Comics & Illustration",
      description: "Funding Comics & Illustration"
    }
  });
  const category6 = await prisma.categories.create({
    data: {
      name: "Films",
      description: "Funding Films"
    }
  });
  const category7 = await prisma.categories.create({
    data: {
      name: "Design & Tech",
      description: "Funding Design & Tech"
    }
  });

  const category8 = await prisma.categories.create({
    data: {
      name: "Games",
      description: "Funding Games"
    }
  });
    ...
    data: {
      ...
      banner: {
        create: [
          {
            image:
              "https://images.unsplash.com/photo-1593924689241-1b78c38f0071?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1964&q=80"
          }
        ]
      }
    }
    ...
    data: {
      ...
      banner: {
        create: [
          {
            image:
              "https://images.unsplash.com/photo-1616474103484-75eabb8f2590?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80"
          }
        ]
      }
    }
    ...
    data: {
      ...
      banner: {
        create: [
          {
            image:
              "https://images.unsplash.com/photo-1520856990214-7a9e59dd5ff7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
          }
        ]
      }
    }
    ...
    data: {
      ...
      banner: {
        create: [
          {
            image:
              "https://images.unsplash.com/photo-1535137755190-8a0b337717e9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2080&q=80"
          }
        ]
      }
    }
    ...
    data: {
      ...
      banner: {
        create: [
          {
            image:
              "https://images.unsplash.com/photo-1522933457979-b1d7dcb19e7a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
          }
        ]
      }
    }
    ...
    data: {
      ...
      banner: {
        create: [
          {
            image:
              "https://images.unsplash.com/photo-1452860606245-08befc0ff44b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
          }
        ]
      }
    }
    ...
    data: {
      ...
      banner: {
        create: [
          {
            image:
              "https://images.unsplash.com/photo-1544047963-0cfb7692fd4b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80"
          }
        ]
      }
    }
